...
parser.add_argument('--split', dest='split',
                    help='dataset split for VidOR.', default='training')
...
if __name__ == "__main__":
    ...
    for folder_idx, folder in enumerate(tqdm(os.listdir(annot_dir))):
        ...
        for video_json in tqdm(os.listdir(os.path.join(annot_dir, folder))):
            ...
            if os.path.isfile(os.path.join(args.vidor_root, 'human_poses', folder, video_idx + '.json')):
            ...
            det_loader = VidorFileDetectionLoader(input_source, cfg, args, folder, video_idx)
            ...
            if args.save_video and mode != 'image':
                ...
                writer = DataWriter(cfg, args, folder, video_idx, save_video=True, video_save_opt=video_save_opt, queueSize=queueSize).start()
            else:
                writer = DataWriter(cfg, args, folder, video_idx, save_video=False, queueSize=queueSize).start()
